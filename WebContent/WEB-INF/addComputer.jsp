...
<section id="main">
    ...
    <form action="addComputer" method="POST">
            ...
            <div class="clearfix ${fn:bitwiseAnd(error_bits,1) == 1 ? 'error' : ''}">                
            ...
            <div class="clearfix ${fn:bitwiseAnd(error_bits,2) == 2 ? 'error' : ''}">                
            ...
            <div class="clearfix ${fn:bitwiseAnd(error_bits,4) == 4 ? 'error' : ''}">                
